...
const isDemo = urlParams.get('demo') === '1' || !urlParams.get('id'); // Tự động demo nếu không có id
...
async function loadGalaxyData() {
    console.log('Loading galaxy data... isDemo:', isDemo, 'galaxyId:', galaxyId);
    if (isDemo) {
        ...
        console.log('Demo data loaded:', galaxyData);
        showStartButton();
...
function initializeGalaxy() {
    console.log('Initializing galaxy with data:', galaxyData);
...
function createTextParticle() {
    ...
    console.log('Creating text particle, active particles:', activeParticles.size);
